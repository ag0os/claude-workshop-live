...
async function main() {
	...
	if (args.values.quick) {
		...
		// Full orientation
		orientationTasks.push(
			"Provide a comprehensive orientation of this project",
		);
		orientationTasks.push(
			"Include project structure, available commands, tech stack, and recent changes",
		);
